...
<div class="App">
	<Router>
		<div class="navbar bg-base-300 mb-4">
			<div class="flex-1">
				<Link to="/home" class="btn btn-ghost normal-case text-xl" style="color:black; text-decoration:none">
					TMS
				</Link>
					<Link to="/usermanagementsystem" class="btn btn-ghost ml-5 normal-case text-lg" style="color:black; text-decoration:none">
						User Management System
					</Link>
					<Link to="/createapp" class="btn btn-ghost normal-case text-lg" style="color:black; text-decoration:none">
						Create Applications
					</Link>
			</div>
			<div class="flex-none gap-2">
				<div class="dropdown dropdown-end">
					...
					<ul tabIndex="0" class="mt-3 p-2 shadow menu menu-compact dropdown-content bg-base-100 rounded-box w-52">
						<li>
							<Link to="/profile" class="justify-between" style="color:black; text-decoration:none">
								Profile
							</Link>
						</li>
						<li>
		...
		<Route path="/usermanagementsystem/updateuser/:username" component={UpdateUser} />
